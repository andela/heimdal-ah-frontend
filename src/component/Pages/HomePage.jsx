...
const HomePage = () => (
  <div>
    <Fragment>
      ...
      <br />
      <br />
      <a href='https://heimdal-ah-staging.herokuapp.com/api/v1/auth/facebook'>
        <Button type="facebook" label="Login with Facebook" />
      </a>
      <br />
      <br />
      <br />
      <a href='https://heimdal-ah-staging.herokuapp.com/api/v1/auth_twitter/twitter'><Button type="twitter" label="Login with Twitter" /></a>
      <br />
      <br />
      <br />
      <a href='https://heimdal-ah-staging.herokuapp.com/api/v1/auth/google'>
